...
class ProgressTracker:
    """
    Simple progress tracking for story generation.
    
    Shows current step and basic progress without overwhelming detail.
    Focuses on major phases rather than granular technical steps.
    """
    ...
    def show_progress_summary(self):
        ...
        if not self.completed_steps or self.session_start_time is None:
            return
