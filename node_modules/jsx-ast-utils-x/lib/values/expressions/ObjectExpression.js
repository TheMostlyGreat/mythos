  ...
  return value.properties.reduce(function (obj, property) {
    ...
    if (/^(?:Experimental)?Spread(?:Property|Element)$/.test(property.type)) {
      if (property.argument.type === 'ObjectExpression') {
        return _objectSpread(_objectSpread({}, obj), extractValueFromObjectExpression(property.argument));
      }
    } else {
      return _objectSpread(_objectSpread({}, obj), {}, _defineProperty({}, getValue(property.key), getValue(property.value)));
    }
    return obj;
  }, {});
}