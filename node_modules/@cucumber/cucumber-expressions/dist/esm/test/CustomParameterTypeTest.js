    ...
    describe('CucumberExpression', () => {
        ...
        describe('conflicting parameter type', () => {
            ...
            it('is not detected for regexp', () => {
                ...
                assert.strictEqual(new CucumberExpression('I have a {css-color} ball', parameterTypeRegistry)
                    .match('I have a blue ball')?.[0]
                    .getValue(null)?.constructor, CssColor);
                assert.strictEqual(new CucumberExpression('I have a {css-color} ball', parameterTypeRegistry)
                    .match('I have a blue ball')?.[0]
                    .getValue(null)?.name, 'blue');
                assert.strictEqual(new CucumberExpression('I have a {color} ball', parameterTypeRegistry)
                    .match('I have a blue ball')?.[0]
        ...
        it('creates arguments using async transform', async () => {
            parameterTypeRegistry = new ParameterTypeRegistry();
            parameterTypeRegistry.defineParameterType(new ParameterType('asyncColor', /red|blue|yellow/, Color, async (s) => new Color(s), false, true));
