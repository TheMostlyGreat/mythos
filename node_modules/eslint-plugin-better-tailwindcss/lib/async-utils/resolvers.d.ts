...
export declare function resolveCss(ctx: AsyncContext, path: string, cwd?: string): string;
export declare function resolveJson(path: string, cwd: string): string | undefined;
