import { array, boolean, description, optional, pipe, strictObject, string } from "valibot";
...
export const enforceCanonicalClasses = createRule({
    ...
    schema: strictObject({
        ...
        ignore: optional(pipe(array(string()), description("A list of regular expression patterns for classes that should be ignored by the rule.")), []),
