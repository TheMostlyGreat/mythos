export declare const enforceLogicalProperties: {
    category: "stylistic";
    messages: {
        readonly multiple: "Physical class detected. Replace \"{{ className }}\" with logical classes \"{{fix}}\".";
        readonly single: "Physical class detected. Replace \"{{ className }}\" with logical class \"{{fix}}\".";
    } | undefined;
...
//# sourceMappingURL=enforce-logical-properties.d.ts.map