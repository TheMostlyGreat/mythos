...
var _default = exports.default = (0, _iterateJsdoc.default)(({
  ...
  //   is still useful
  if (!allowedNodes.includes(nde.type) || nde.type === 'TSPropertySignature' && (/** @type {import('@typescript-eslint/types').TSESTree.TSPropertySignature} */nde?.typeAnnotation?.typeAnnotation?.type !== 'TSFunctionType')) {
    return;
  }
