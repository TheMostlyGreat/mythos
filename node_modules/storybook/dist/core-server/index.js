import CJS_COMPAT_NODE_URL_pt912roydgi from 'node:url';
import CJS_COMPAT_NODE_PATH_pt912roydgi from 'node:path';
import CJS_COMPAT_NODE_MODULE_pt912roydgi from "node:module";

var __filename = CJS_COMPAT_NODE_URL_pt912roydgi.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_pt912roydgi.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_pt912roydgi.createRequire(import.meta.url);
...
import {
  pLimit
} from "../_node-chunks/chunk-YELFZJ2B.js";
import {
  UniversalStore,
  analyzeTestResults,
  debounce,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-TQLYOGGH.js";
import "../_node-chunks/chunk-L64YPGUF.js";
import {
  Tag
} from "../_node-chunks/chunk-HT5O7ZWA.js";
import {
  UNIVERSAL_STATUS_STORE_OPTIONS,
  createStatusStore,
  detectPnp
} from "../_node-chunks/chunk-FS7UJHJO.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-SSLFYQA4.js";
import {
  StorybookError
} from "../_node-chunks/chunk-XZNPZNTE.js";
import {
  isTelemetryModuleEnabled,
  telemetry
} from "../_node-chunks/chunk-MI22B6QL.js";
import "../_node-chunks/chunk-AVCEQXMX.js";
import "../_node-chunks/chunk-RLSKSEJD.js";
import {
  execa,
  require_cross_spawn,
  resolveImport,
...
} from "../_node-chunks/chunk-3FBJJ3J7.js";
import "../_node-chunks/chunk-OOFBFCWG.js";
import "../_node-chunks/chunk-ONBWXGRU.js";
import {
  logger,
  require_pretty_hrtime
} from "../_node-chunks/chunk-3X73JSWN.js";
import "../_node-chunks/chunk-NMZ2FUOR.js";
import {
  optionalEnvToBoolean
} from "../_node-chunks/chunk-OPPP3ZVD.js";
import "../_node-chunks/chunk-WVKUKJCY.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-LGWDBQCF.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-ULZBLQ6I.js";
import "../_node-chunks/chunk-UX445D4A.js";
import {
  dirname,
  extname,
  isAbsolute,
  ...
  relative,
  resolve
} from "../_node-chunks/chunk-75LGFSSP.js";
import {
  require_dist
} from "../_node-chunks/chunk-DKPTV7OY.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-Q6DQCNHY.js";
import {
  slash
} from "../_node-chunks/chunk-X7PI2AKG.js";
import "../_node-chunks/chunk-OPKU3YFW.js";
import {
  __commonJS,
  __esm,
  __export,
  ...
  __toCommonJS,
  __toESM
} from "../_node-chunks/chunk-H3J77TM6.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-ML5UXL3U.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-W5ZVMK2K.js");
...
import { CLI_COLORS as CLI_COLORS2, deprecate, logger as logger20, prompt } from "storybook/internal/node-logger";
...
var GitDiffProvider = class {
  constructor(cwd = process.cwd(), fileSystem = { watch, readFile, stat }) {
    this.cwd = cwd;
    ...
    if (skippedRegex.length > 0) {
      ...
      if (newPatterns.length > 0) {
        ...
        for (let pattern of skippedRegex)
          logger9.debug(`ChangeDetectionResolverFactory: skipping regex alias '${pattern}'`);
    }
...
var ParserRegistry = class {
  ...
  register(plugin) {
    for (let ext of plugin.extensions) {
      ...
      this.byExtension.has(lower) && logger10.debug(`ParserRegistry: ${lower} parser overridden`), this.byExtension.set(lower, plugin.parse);
    }
  }
  parserFor(filePath) {
...
var ChangeDetectionService = class {
  ...
  start(adapter, enabled) {
    if (enabled === !1) {
      logger11.debug("Change detection disabled."), this.resolveReadiness({
        status: "unavailable",
        reason: "disabled"
      });
      return;
    ...
    if (!adapter) {
      logger11.warn("Change detection unavailable: builder does not support change detection"), this.resolveReadiness({
        status: "unavailable",
        reason: "builder does not support change detection"
      });
      return;
    }
    logger11.debug("Change detection enabled."), this.adapter = adapter, this.startInternal().catch((error) => {
      if (this.disposed)
        return;
      let failure = error instanceof Error ? error : new ChangeDetectionFailureError(String(error));
      logger11.error(`Change detection failed to start: ${failure.message}`), this.resolveReadiness({ status: "error", error: failure }), this.dispose().catch(() => {
      });
    });
  }
  /**
  ...
  async startInternal() {
    ...
    let resolveConfig = await adapter.getResolveConfig(), projectRoot = normalize(resolveConfig.projectRoot ?? this.workingDir), pluginParsers = this.options.presets ? await this.options.presets.apply("experimental_importParsers", []) : [], registry = new ParserRegistry({
      ...
      pluginParsers
    }), resolver2 = new ChangeDetectionResolverFactory(resolveConfig), workspaceRoots = /* @__PURE__ */ new Set([normalize(getProjectRoot())]), storyIndex = await (await this.options.storyIndexGeneratorPromise).getIndex(), storyIdsByFile = getStoryIdsByAbsolutePath(
    ...
    if (!this.disposed) {
      ...
      this.unsubscribeFileChange = adapter.onFileChange((event) => {
        ...
        this.disposed || (logger11.warn(`Change detection unavailable: ${event.reason}`), this.resolveReadiness({
          status: "unavailable",
          reason: event.reason,
          error: event.error
        }), this.dispose());
  ...
  async dumpDebugSnapshot(reverseIndex, graph, projectRoot, workspaceRoots, cache4) {
    ...
    try {
      await writeFile4(outPath, JSON.stringify(snapshot, null, 2), "utf8"), logger11.debug(`Change detection: graph debug snapshot written to ${outPath}`);
    } catch (error) {
      logger11.warn(
    ...
    if (!(this.disposed || !this.reverseIndex || (await this.patchQueue.catch(() => {
      ...
      try {
        ...
        if (error instanceof ChangeDetectionUnavailableError)
          logger11.warn(`Change detection unavailable: ${error.message}`), this.resolveReadiness({
            status: "unavailable",
            reason: error.message,
            error
          }), await this.dispose();
        else if (error instanceof ChangeDetectionFailureError)
          logger11.error(`Change detection failed: ${error.message}`), this.resolveReadiness({
            status: "error",
            error
          });
        else {
          ...
          logger11.error(`Change detection failed: ${failure.message}`), this.resolveReadiness({
            status: "error",
            error: failure
          });
        }
...
Note: BROWSER environment variable is set to "${browserEnv}". To disable browser opening, use BROWSER=none or the --ci flag.` : "";
      logger13.error(import_ts_dedent.dedent`
...
async function storybookDevServer(options, server) {
  ...
  if (!options.ignorePreview && (features.changeDetection || changeDetectionService.start(void 0, !1), logger14.debug("Starting preview.."), previewResult = await previewBuilder.start({
    startTime: process.hrtime(),
    options,
    router: app,
    server,
    ...
    throw logger14.error("Failed to build the preview"), process.exitCode = 1, await changeDetectionService.dispose().catch(() => {
    ...
    try {
      ...
      logger14.warn("Change detection: adapter initialisation failed"), logger14.debug(err instanceof Error ? err.stack ?? err.message : String(err));
    }
...
import { CLI_COLORS, logger as logger15 } from "storybook/internal/node-logger";
...
var getServerPort = (port, { exactPort } = {}) => (0, import_detect_port.default)(port).then((freePort) => (freePort !== port && exactPort && process.exit(-1), freePort)).catch((error) => {
  logger16.error(error), process.exit(-1);
...
async function getServer(options) {
  ...
  options.sslCert || (logger17.error("Error: --ssl-cert is required with --https"), process.exit(-1)), options.sslKey || (logger17.error("Error: --ssl-key is required with --https"), process.exit(-1));
  let sslOptions = {
    ca: await Promise.all((options.sslCa || []).map((ca) => readFile3(ca, { encoding: "utf8" }))),
    cert: await readFile3(options.sslCert, { encoding: "utf8" }),
    key: await readFile3(options.sslKey, { encoding: "utf8" })
  };
...
var checkPackageCompatibility = async (dependency, context) => {
  ...
  try {
    ...
    return skipErrors || logger18.log(
...
var warnOnIncompatibleAddons = async (currentStorybookVersion, packageManager) => {
  ...
  incompatiblePackagesMessage && logger19.warn(incompatiblePackagesMessage);
};
...
async function warnWhenUsingArgTypesRegex(previewConfigPath, config) {
  let previewContent = previewConfigPath ? await readFile4(previewConfigPath, { encoding: "utf8" }) : "";
  (config?.addons?.some(
...
async function buildDevStandalone(options) {
  ...
  let cacheKey = oneWayHash(relative(getProjectRoot2(), configDir));
  ...
  try {
    ...
    logger20.warn("Storybook failed to check addon compatibility"), logger20.debug(`${e instanceof Error ? e.stack : String(e)}`);
  }
  try {
  ...
  if (options.host === "0.0.0.0" && (!allowedHosts || allowedHosts !== !0 && allowedHosts.length === 0) && logger20.warn(import_ts_dedent5.dedent`
  ...
  if (resolvedPreviewBuilder.includes("builder-vite")) {
    ...
    let mainJsContent = await readFile5(mainJsPath, { encoding: "utf8" }), CJS_CONTENT_REGEX = /\bmodule\.exports\b|\bexports[.[]|\brequire\s*\(|\bObject\.(?:defineProperty|defineProperties|assign)\s*\(\s*exports\b/, strippedContent = stripCommentsAndStrings(mainJsContent);
  ...
  if (options.smokeTest) {
    ...
    problems.length > 0 ? (logger20.error("Smoke tests failed."), logger20.log(problems.map((p) => p.stack).join(`
`))) : logger20.step(CLI_COLORS2.success("Smoke tests passed, exiting.")), logger20.outro(""), process.exit(problems.length > 0 ? 1 : 0);
  } else {
...
import { dirname as dirname2, extname as extname2, join as join6, normalize as normalize2, relative as relative4, resolve as resolve3, sep } from "node:path";
import { commonGlobOptions as commonGlobOptions2, getProjectRoot as getProjectRoot4, normalizeStoryPath } from "storybook/internal/common";
...
import { logger as logger21, once } from "storybook/internal/node-logger";
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join6(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-W5ZVMK2K.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
    ...
    return files.length === 0 && !ignoreWarnings && once.warn(
      ...
      if (ext === ".storyshot") {
        ...
        logger21.info(`Skipping ${ext} file ${relativePath}`);
        return;
      }
  ...
  async extractDocs(specifier, absolutePath, projectTags = []) {
    ...
    try {
      let normalizedPath = normalizeStoryPath(relativePath), importPath = slash(normalizedPath), content3 = await readFile6(absolutePath, { encoding: "utf8" }), result = await analyzeMdx(content3);
      ...
      throw err && err.source?.match(/mdast-util-mdx-jsx/g) && logger21.warn(
  ...
  async getIndexAndStats() {
    ...
    try {
      ...
      throw this.lastError = err == null || err instanceof Error ? err : void 0, invariant(this.lastError), logger21.warn(`\u{1F6A8} ${this.lastError.toString()}`), this.lastError;
    }
  }
  invalidateAll() {
  ...
  async getPreviewCode() {
    let previewFile = ["js", "jsx", "ts", "tsx", "mjs", "cjs", "mts"].map((ext) => join6(this.options.configDir, `preview.${ext}`)).find((fname) => existsSync2(fname));
    return previewFile && (await readFile6(previewFile, { encoding: "utf8" })).toString();
  }
