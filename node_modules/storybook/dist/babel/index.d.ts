...
export { type BabelFile, BabelFileClass, type GeneratorOptions, NodePath, babelParse, babelParseExpression, babelPrint, canUpdateVitestConfigFile, canUpdateVitestWorkspaceFile, index_d as core, generate, getConfigObjectFromMergeArg, getEffectiveMergeConfigCall, getTargetConfigObject, isDefineConfigLike, isImportedDefineConfigLikeIdentifier, babelParser_d as parser, parserOptions, resolveExpression, transformSync, traverse, index_d$1 as types, unwrapTSExpression };
